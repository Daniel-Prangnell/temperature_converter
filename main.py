...
class converter:
  ...
  def __init__(self):
    #initialise Veriables (such as the feedback veriables)
  ...
  # check user input and if its valid, converts temperature
  def check_temp(self, min_value):
    ...
    # sets var_has_error so entry box and labels can be corrctly formatted by formating function
